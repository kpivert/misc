...
server <- shinyServer(function(input, output) {
    ...
    data <- tibble(
                name = c("San Francisco", "New York", "Los Angeles", "London", "Hyderabad", "Charlottesville"),
                latitude = c(37.7751, 40.6643, 34.051597, 51.5074, 17.3850, 38.0293),
                longitude = c(-122.4193, -73.9385, -118.244263, -0.1278, 78.4867, -78.4767)
            )
    
    centroids <- data.frame(sigla_muni = c("San Francisco", "New York", "Los Angeles", "London", "Hyderabad", "Charlottesville"),
                            lon = c(-122.4193, -73.9385, -118.244263, -0.1278, 78.4867, -78.4767),
                            lat = c(37.7751, 40.6643, 34.051597, 51.5074, 17.3850, 38.0293)
                            )
